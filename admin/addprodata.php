...
// print_r($_POST['procat']);
    ...
    if (!empty($pname) && !empty($pdes) && !empty($pcat) && !empty($pprice) && !empty($pcode) && !empty($pimage)) {
        $insert = "INSERT INTO `products` (`pid`, `pname` , `pdes`,`pcategory`, `pnumber`, `pprice`, `pimage`) VALUES (NULL, '$pname','$pdes','$pcat', CONCAT('$pcode', '-' , FLOOR(10000 + RAND() * 90000)), '$pprice', '$pimage')";
